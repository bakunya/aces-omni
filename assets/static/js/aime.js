(function(){
  ...
  function setItem(item) {
    ...
    aimeflag.innerText = "...";
    aimeprompt.innerText = item.prompt;
    btnNext.disabled = true;
    document.querySelectorAll('input[name="aime"]').forEach(e => {
      e.checked = false;
    })
  ...
  function showApp() {
    ...
    document.querySelectorAll('input[name="aime"]').forEach(elm => {
      elm.addEventListener('change', (e) => {
        ...
        aimeflag.innerText = LIKERT[e.target.value];
